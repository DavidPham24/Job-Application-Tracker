// This file contains the Express application setup and routes (separated from server.js for easier testing).

const { validateApplication } = require("./middleware/applicationValidation"); // Validates user input for POST and PUT.
